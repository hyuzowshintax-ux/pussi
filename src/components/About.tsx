        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white font-semibold text-sm shadow-md shadow-emerald-600/30 transition-all"
              >
                Mulai Kolaborasi
              </a>
              <button
          ...
          <div className="lg:col-span-6">
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-6 border border-emerald-500/25">
              <h3 className="text-lg font-bold text-white dark:text-white light:text-slate-900 flex items-center space-x-2 pb-3 border-b border-slate-700/50 dark:border-slate-700/50 light:border-slate-200">
                ...
                <span>Informasi Pribadi & Domisili</span>
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {about.details.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-start space-x-3 p-3.5 rounded-xl bg-slate-900/60 dark:bg-slate-900/60 light:bg-slate-100/70 border border-emerald-500/20 dark:border-emerald-500/20 light:border-slate-200"
                  >
